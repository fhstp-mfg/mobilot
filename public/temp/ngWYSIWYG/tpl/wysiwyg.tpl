<div class="tinyeditor">
  <div class="tinyeditor-header" ng-hide="editMode">
    <div ng-hide="editMode" layout="column">
        ...
        <div layout="column" flex>
          ...
          >
            <md-button
              ...
              aria-label="Text"
              ng-click="changeTextStyle('p')"
            >Text</md-button>
            <md-button
              class="custom-wysiwyg-button md-mobilot"
              aria-label="Titel"
              ng-click="changeTextStyle('h1')"
            >Titel</md-button>

            <md-button
              class="custom-wysiwyg-button md-mobilot"
              aria-label="Untertitel"
              ng-click="changeTextStyle('h2')"
            >Untertitel</md-button>
          </div>

          <div layout-xs="row" layout-align="space-between center">
            <md-button
          ...
          <div layout-xs="row" layout-align="space-between start" flex>
            <md-button
              class="md-raised md-mobilot tinyeditor-control"
