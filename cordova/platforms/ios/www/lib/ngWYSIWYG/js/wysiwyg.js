...
angular.module('ngWYSIWYG').directive('wysiwygEdit', ['$compile', '$timeout', '$stateParams', '$http',
    function($compile, $timeout, $stateParams, $http) {
	var linker = function( scope, $element, attrs, ctrl ) {
...
//  		scope.execCommand('insertimage', val);
                ...
                if (file != null) {
                    ...
                    reader.onloadend = function () {
                        ...
                        image.onload = function () {
                            ...
                            var newFileName = scope.file.name.split('.');
        ...
        scope.drawImageIOSFix = function (ctx, img, sx, sy, sw, sh, dx, dy, dw, dh, exifOr) {
        ...
        scope.detectVerticalSquash = function (img) {
